...
class UsageAnomalyDetectorStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        application_prefix = CfnParameter(self, 'applicationPrefix',
            type = "String",
        ...
        opensearch_alert_email = CfnParameter(self, 'opensearchAlertEmail',
            type = "String",
        ...
        # cloudtrail trail
        trail_bucket = s3.Bucket(self, 'usage-anomaly-detector-trail-bucket',
        ...
        trail = cloudtrail.Trail(self, 'usage-anomaly-detector-trail',
            trail_name = application_prefix,
        ...
        domain_user_pool = cognito.CfnUserPool(self, 'opensearch-cognito-user-pool',
        ...
        cognito.CfnUserPoolDomain(self, 'opensearch-cognito-user-pool-domain',
            domain =  f"{application_prefix}-{cognito_domain_suffix}",
            user_pool_id = domain_user_pool.ref
        )

        domain_identity_pool = cognito.CfnIdentityPool(self, 'opensearch-cognito-identity-pool',
            allow_unauthenticated_identities = False,
            cognito_identity_providers = []  
        )

        ## opensearch limited role
        opensearch_limited_user_role = iam.Role(self, 'opensearch-limited-user-role',
        ...
        opensearch_admin_user_role = iam.Role(self, 'opensearch-admin-user-role',
        ...
        cognito.CfnUserPoolGroup(self, 'opensearch-cognito-user-pool-group',
            user_pool_id = domain_user_pool.ref,
        ...
        cloudwatch_to_opensearch_lambda_role = iam.Role(self, 'cloudwatch-to-opensearch-lambda-role',
        ...
        opensearch_admin_fn_role = iam.Role(self, 'opensearch-admin-fn-role',
            assumed_by = iam.ServicePrincipal("lambda.amazonaws.com"),
            description = 'iam role for opensearch admin function',
            managed_policies=[iam.ManagedPolicy.from_aws_managed_policy_name("service-role/AWSLambdaBasicExecutionRole")]
        )

        opensearch_http_policy = iam.ManagedPolicy(self, 'opensearch-http-policy',
        ...
        opensearch_alerts_sns_role = iam.Role(self, 'opensearch-alerts-sns-role',
        ...
        alert_topic = sns.Topic(self, "usage-anomaly-detector-alert-topic",
            topic_name = f'{application_prefix}-alert-topic',
        ...
        notif_topic = sns.Topic(self, "usage-anomaly-detector-notif-topic",
            topic_name = f'{application_prefix}-notif-topic',
        ...
        opensearch_alert_notif_fn_role = iam.Role(self, 'opensearch-alerts-notif-fn-role',
            assumed_by = iam.ServicePrincipal("lambda.amazonaws.com"),
        ...
        ## opensearch role
        opensearch_role = iam.Role(self, 'opensearch-role',
        ...
        domain = opensearch.Domain(self, 'usage-anomaly-detector-os',
        ...
        domain_user_pool_clients = cr.AwsCustomResource(self, 'opensearch-cognito-client-id-resource',
        ...
        cloudwatch_to_opensearch_lambda_function = _lambda.Function(self, 'cloudwatch-to-opensearch-lambda-function',
            ...
            role = cloudwatch_to_opensearch_lambda_role,
            environment = {
        ...
        cloudwatch_log_subscription = logs.SubscriptionFilter(self, 'usage-anomaly-detector-logs-subs-filter',
        ...
        opensearch_config_function_layer = _lambda.LayerVersion(self, 'opensearch-config-function-layer',
            code = _lambda.Code.from_asset(path.join(SHARED_DIR)),
            compatible_runtimes=[_lambda.Runtime.PYTHON_3_9]
        )
        
        # opensearch config - function trigger
        opensearch_config_function = _lambda.Function(self, 'opensearch-config-function',
            ...
            environment = {
                "OPENSEARCH_HOST": domain.domain_endpoint
            }
        )

        opensearch_config_fn_provider = cr.Provider(self, 'opensearch-config-fn-provider',
            on_event_handler = opensearch_config_function,
            log_retention=logs.RetentionDays.ONE_DAY
        )
       
        opensearch_config_cr = CustomResource(self, 'opensearch-config',
        ...
        opensearch_anomalydetector_function = _lambda.Function(self, 'opensearch-anomalydetector-function',
        ...
        opensearch_anomalydetector_fn_provider = cr.Provider(self, 'opensearch-anomalydetector-fn-provider',
            on_event_handler = opensearch_anomalydetector_function,
            log_retention=logs.RetentionDays.ONE_DAY
        )

        opensearch_anomalydetector_cr = CustomResource(self, 'opensaerch-anomalydetector',
        ...
        opensearch_anomalydetector_notif_function = _lambda.Function(self, 'opensearch-anomalydetector-notif-function',
        ...
        CfnOutput(self, 'Opensearch dashboard endpoint',
        ...
        CfnOutput(self, 'Opensearch create user url',
